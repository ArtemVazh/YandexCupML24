...
config["train"]["dataset_path"] = "../data/train"
config["val"]["dataset_path"] = "../data/train"
config["test"]["dataset_path"] = "../data/test"
config["test"]["batch_size"] = 256

ensemble_filename = "ensemble_final_v0.1"

test_loader = dataloader_factory(config=config, data_split="test")

paths = ["./workdir/2024-10-30/20-52-59/model",
         "./workdir/2024-10-31/16-47-52-chunk_mixup_ls/model",
         "./workdir/2024-11-02/01-16-12-chunk_mixup_ls_overall/model",
         "./workdir/2024-11-02/13-59-37-chunk_mixup_ls_overall_seed777/model",
         "./workdir/2024-11-02/13-59-36-chunk_mixup_ls_overall_seed123456789/model"]

model_types = ["chunk_opt", "chunk_opt", "chunk_opt_v5", "chunk_opt_v5", "chunk_opt_v5"]
cache_path = "./workdir/cache_predictions/"

os.makedirs(cache_path, exist_ok = True)
os.makedirs("./workdir/ensemble", exist_ok = True)

...
ensemble_filename = "ensemble_final_v0.2_flatten"
...
for k, (path, model_type) in enumerate(zip(paths, model_types)):
    ...
    for i, model in tqdm(enumerate(models)):
        ...
        m = len(predictions_folds)
        predictions_folds[m] = predictions
...
final_predictions = average_predictions(predictions_folds, top_items=100)
